This is the Museum Reviewer App.  It allows Users to create their own reviews of Museums they have visited, add comment on their reviews and on other reviews.

To install, clone the repo at https://github.com/munroe1786/museum-reviewer into a text editor, then run rake db:migrate, then Shotgun.  Navigate to the localhost server in your browser to begin using the app.
